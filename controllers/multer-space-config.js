...
const s3Client = new S3Client({
    endpoint: "https://frank-space.fra1.digitaloceanspaces.com", // This should be the endpoint for your Space (without `/public`)
    region: "fra1", // Region of your space (adjust if necessary)
    credentials: {
